...
},
{
    ...
    a: [{ text: "Slushie", isCorrect: false, isSelected: false },
        { text: "Soda", isCorrect: false },
...
op1.addEventListener("click", () => {
    op1.style.backgroundColor = "silver";
...
op2.addEventListener("click", () => {
    ...
    op2.style.backgroundColor = "silver";
    op3.style.backgroundColor = "";
    op4.style.backgroundColor = "";
    selected = op2.value;
})
...
op3.addEventListener("click", () => {
    op1.style.backgroundColor = "";
    op2.style.backgroundColor = "";
    op3.style.backgroundColor = "silver";
    op4.style.backgroundColor = "";
    selected = op3.value;
})
...
op4.addEventListener("click", () => {
    ...
    op2.style.backgroundColor = "";
    op3.style.backgroundColor = "";
    op4.style.backgroundColor = "silver";
    selected = op4.value;
})
